...
const ICONS = {
  ...
  assistant: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" width="1em" height="1em"><rect x="4" y="4" width="16" height="14" rx="4"/><path d="M9 9h.01"/><path d="M15 9h.01"/><path d="M9 14h6"/><path d="M12 18v3"/><path d="M8 21h8"/></svg>',
