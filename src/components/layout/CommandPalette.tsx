...
const TRENDING: SearchResult[] = [
  ...
  { id: "trend-5", title: "AI 专属助理", subtitle: "与 AI 对话", type: "nav", href: "/ai/assistant", icon: Bot, color: "text-cognition" },
];
...
const QUICK_COMMANDS: QuickCommand[] = [
  ...
  { id: "cmd-converge", input: "converge", label: "跳转到 收敛仪式", description: "/converge", icon: Moon, color: "text-northstar", kind: "navigate", target: "/converge" },
...
export function CommandPalette() {
  ...
  return (
    <div
      className="fixed inset-0 z-[90] flex items-start justify-center bg-black/50 p-4 pt-[10vh] backdrop-blur-sm"
